import keras
from keras.layers import Input, Dense, Dropout, concatenate, LocallyConnected2D, AveragePooling1D, BatchNormalization, \
    Activation, Flatten, noise, Lambda, Conv1D
from keras.layers.advanced_activations import LeakyReLU, ELU
from keras.models import Model
from keras.optimizers import Adam
from keras.regularizers import l2

from DNNBrainSpeechRecon.neural_tools.metrics_and_losses import corr2_mse_loss
...
def simplified_resnet(input_shape, depth, last_filter=1):
    # Start model definition.
    inputs = Input(shape=input_shape)
    x = resnet_layer(inputs=inputs)
    # Instantiate the stack of residual units
