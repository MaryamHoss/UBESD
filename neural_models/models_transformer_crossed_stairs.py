...
class Decoder(tf.keras.layers.Layer):
    ...
    def call(self, inputs, training=None):
        ...
        rev_enc_outputs = list(reversed(enc_outputs))
        for i in range(self.num_layers):
            decoder_output, block1, block2 = self.dec_layers[i]([decoder_output, rev_enc_outputs[i]])
...
class TransformerCrossedStairs(tf.keras.layers.Layer):
    def __init__(self, num_layers, d_model, num_heads, dff,
